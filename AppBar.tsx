  ...
  return (
    ...
    <header className="fixed top-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-3xl z-[200] border-b border-white/5 px-3 flex items-center justify-between shadow-[0_15px_50px_rgba(0,0,0,0.9)]">
      ...
      >
        ...
        {/* Reduced Logo Size w-14 to w-11 and replaced with dynamic Logo */}
        <Logo className="w-11 h-11 rounded-full border border-red-500 relative z-10 shadow-[0_0_25px_red] group-hover:shadow-[0_0_50px_red] transition-all object-cover" />
      </button>
